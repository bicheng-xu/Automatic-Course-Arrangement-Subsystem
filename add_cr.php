            ...
            <ul class="nav navbar-nav">
              <li class="dropdown">
                <a href="" class="dropdown-toggle" data-toggle="dropdown">Other Subsystem<b class="caret"></b></a>
                  ...
                  <li class="divider"></li>
                  <li><a href="main.html">Automatic Course Arrangement Subsystem</a></li>
                  <li class="divider"></li>
                  <li><a href="../css/">Course Selection Subsystem</a></li>
                  <li class="divider"></li>
                  <li><a href="../ots/login.php">Online Testing Subsystem</a></li>
                  <li class="divider"></li>
...
if($_SESSION['user_type']!=1)
{
  ...
  @ $cr_camp=$_POST['cr_camp'];


  if (!$cr_ID||!$cr_Name||!$cr_Type||!$cr_capa||!$cr_camp) {
    ...
    if (!get_magic_quotes_gpc()){
        ...
        $cr_Name=addslashes($cr_Name);
        $cr_Type=addslashes($cr_Type);
        $cr_capa=addslashes($cr_capa);
        $cr_camp=addslashes($cr_camp);
    }
...
exit();
    ...
    $sql2="select * from acaRoom where room_name='".$cr_Name."'";
    $res2=mysqli_query($con,$sql2);
    $newArray2 = mysqli_fetch_array($res2, MYSQLI_ASSOC);
    if(!$newArray2)
    {
	$sql="insert into acaRoom
	     values ('".$cr_ID."','".$cr_Name."','".$cr_Type."','".$cr_capa."','".$cr_camp."')";
  ...
  {
    echo "<script>alert('We already have this classroom, Please try again')</script>";
  }
    Mysqli_close($con);
  }
?>
